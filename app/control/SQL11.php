...
class SQL11 extends TPage
{
    ...
    public function __construct()
    {
        ...
        $question = new TPanelGroup('Questão 11');

        $label = new TLabel('Aplique um aumento de 10% no preço de todos os produtos que custam menos de R$50,00.');
