...
class SQL6 extends TPage
{
    ...
    public function __construct()
    {
        ...
        $question = new TPanelGroup('Questão 6');

        $label = new TLabel('Última Compra de Cada Cliente: Para cada cliente, mostre a data do último pedido realizado.');
