...
class SQL10 extends TPage
{
    ...
    public function __construct()
    {
        ...
        $question = new TPanelGroup('Questão 10');

        $label = new TLabel('Ranking de Clientes: Liste os clientes em ordem decrescente de total gasto, incluindo a posição (1º, 2º, 3º, etc.).');
