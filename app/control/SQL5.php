...
class SQL5 extends TPage
{
    ...
    public function __construct()
    {
        ...
        $question = new TPanelGroup('Questão 5');

        $label = new TLabel('Cliente com Maior Gasto: Encontre o cliente que mais gastou em pedidos e informe o valor total gasto.');
