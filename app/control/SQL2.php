...
class SQL2 extends TPage
{
    ...
    public function __construct()
    {
        ...
        $question = new TPanelGroup('Questão 2');

        $label = new TLabel('Total de Vendas por Cliente: Para cada cliente, mostre o total gasto em pedidos.');
