...
class SQL4 extends TPage
{
    ...
    public function __construct()
    {
        ...
        $question = new TPanelGroup('Questão 4');

        $label = new TLabel('Produto Mais Vendido: Identifique qual produto foi o mais vendido (considerando a soma das quantidades).');
