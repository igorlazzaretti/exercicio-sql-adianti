...
class SQL9 extends TPage
{
    ...
    public function __construct()
    {
        ...
        $question = new TPanelGroup('Questão 9');

        $label = new TLabel('Produto Mais Caro em Cada Pedido: Para cada pedido, exiba o nome do produto mais caro comprado e seu preço unitário.');
