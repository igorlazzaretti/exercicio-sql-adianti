...
class SQL3 extends TPage
{
    ...
    public function __construct()
    {
        ...
        $question = new TPanelGroup('Questão 3');

        $label = new TLabel('Pedidos Acima da Média: Liste os pedidos cujo valor total seja maior que a média de todos os pedidos.');
