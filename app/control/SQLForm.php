...
class SQLForm extends TPage
{
    ...
    public function __construct()
    {
        ...
        // Cria o formulário de entrada SQL
        ...
        $this->sql_entry->setSize('100%', 200); // height in pixels
        ...
        $this->table->style = 'height: 41vh; overflow-y: auto; font-family: monospace; white-space: pre;';
